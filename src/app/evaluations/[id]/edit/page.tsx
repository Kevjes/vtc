  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        const initialScores: EvaluationScore[] = evaluationData.scores.map(score => ({
          uuid: score.uuid,
  ...
  useEffect(() => {
    if (evaluation) {
      ...
      const hasScoreChanges = scores.some(score => {
        const originalScore = evaluation.scores.find(s => s.criteria.uuid === score.criteriaUuid)
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <Badge variant={evaluation.status === 'PENDING' ? 'warning' : 'secondary'}>
